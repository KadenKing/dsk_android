...
*/
    ...
    if (Option* p = dynamic_cast<Option*> (graphParser->getParser(STR_URI_INPUT)))  {  p->setDefaultValue ("/sdcard/Download/Test/Salmonella.fastq"); }
    if (Option* p = dynamic_cast<Option*> (graphParser->getParser(STR_URI_OUTPUT_DIR)))  {  p->setDefaultValue ("/sdcard/Download/Test/out"); }
    if (Option* p = dynamic_cast<Option*> (graphParser->getParser(STR_URI_OUTPUT_TMP)))  {  p->setDefaultValue ("/sdcard/Download/Test/out"); }
    if (Option* p = dynamic_cast<Option*> (graphParser->getParser(STR_URI_OUTPUT)))  {  p->setDefaultValue ("/sdcard/Download/Test/out"); }
    if (Option* p = dynamic_cast<Option*> (graphParser->getParser(STR_STORAGE_TYPE)))  {  p->setDefaultValue ("file"); }
    if (Option* p = dynamic_cast<Option*> (graphParser->getParser(STR_MAX_MEMORY)))  {  p->setDefaultValue ("200"); }
    if (Option* p = dynamic_cast<Option*> (graphParser->getParser(STR_NB_CORES)))  {  p->setDefaultValue ("1"); }
